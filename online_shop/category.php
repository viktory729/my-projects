            ...
            <div class="row">
               <div class="col-md-10">
                                ...
                                <div class="media-body">
                                    ...
                                    ?>
                                     ...
                                     <ul class="list-inline list-inline-dotted mb-3 mb-lg-2">
                                        <li class="list-inline-item"><a href="#" class="text-muted" data-abc="true"><?php echo $ct2['category']; ?></a></li>
                                        <li class="list-inline-item"><a href="#" class="text-muted" data-abc="true"><?php echo $ct1['brand']; }?></a></li>
                                    </ul>
                                  
                                      <p class="mb-3"><?php echo $row['about']; ?></p>
                                ...
                                <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                                    ...
                                    <?php
                                     echo '<a href="cart1.php?action=add&id='.$row["id"].'" name = "add_to_cart" class="cart-btn"><button type="button" class="btn btn-warning mt-4 text-white"><i class="icon-cart-add mr-2"></i>Добавить в корзину</button></a>';
                                    ?>
                                </div>
                            </div>
                        </div>
