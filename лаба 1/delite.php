...
<html>
    ...
    <body>
        ...
        $id =  $_GET['id'];
        $Cars = 'DELETE FROM `Cars` WHERE `id` = '.$id;
        $Specification = 'DELETE FROM `Specification` WHERE `id` = '.$id; 
        $bb = $db->query($Cars);
        $bb2 = $db->query($Specification);
        ?>

        <div class="container1" style="text-align:center; margin-top:5%;">
            <div class="blog_post">
                <div class="container_copy">
                    <h1 style="margin-bottom:50px;">Запись удалена</h1>
